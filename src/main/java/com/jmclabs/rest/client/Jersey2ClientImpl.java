...
public class Jersey2ClientImpl implements Jersey2Client {

	private static final Logger s_logger = LoggerFactory.getLogger(Jersey2ClientImpl.class);
	...
	private final ScheduledExecutorService eurekaConnCleaner = Executors
	...
	public Jersey2ClientImpl(int connectionTimeout, int readTimeout, final int connectionIdleTimeout,
		...
		try {
			...
			eurekaConnCleaner.scheduleWithFixedDelay(connectionCleanerTask, HTTP_CONNECTION_CLEANER_INTERVAL_MS,
					HTTP_CONNECTION_CLEANER_INTERVAL_MS, TimeUnit.MILLISECONDS);
		} catch (Throwable e) {
	...
	public static class Jersey2ClientBuilder {
		...
		public Jersey2ClientBuilder withClientName(String clientName) {
			this.clientName = clientName;
			return this;
		}

		public Jersey2ClientBuilder withUserAgent(String userAgent) {
			this.userAgent = userAgent;
			return this;
		}

		public Jersey2ClientBuilder withConnectionTimeout(int connectionTimeout) {
			this.connectionTimeout = connectionTimeout;
			return this;
		}

		public Jersey2ClientBuilder withReadTimeout(int readTimeout) {
			this.readTimeout = readTimeout;
			return this;
		}

		public Jersey2ClientBuilder withConnectionIdleTimeout(int connectionIdleTimeout) {
			this.connectionIdleTimeout = connectionIdleTimeout;
			return this;
		}

		public Jersey2ClientBuilder withMaxConnectionsPerHost(int maxConnectionsPerHost) {
			this.maxConnectionsPerHost = maxConnectionsPerHost;
			return this;
		}

		public Jersey2ClientBuilder withMaxTotalConnections(int maxTotalConnections) {
			this.maxTotalConnections = maxTotalConnections;
			return this;
		}

		public Jersey2ClientBuilder withProxy(String proxyHost, String proxyPort, String user, String password) {
		...
		public Jersey2ClientBuilder withSystemSSLConfiguration() {
			this.systemSSL = true;
			return this;
		}

		public Jersey2ClientBuilder withTrustStoreFile(String trustStoreFileName, String trustStorePassword) {
			this.trustStoreFileName = trustStoreFileName;
			this.trustStorePassword = trustStorePassword;
			return this;
		}

		// public Jersey2ClientBuilder withEncoder(String encoderName) {
		// return
		// this.withEncoderWrapper(CodecWrappers.getEncoder(encoderName));
		// }

		// public Jersey2ClientBuilder withEncoderWrapper(EncoderWrapper
		// encoderWrapper) {
		// this.encoderWrapper = encoderWrapper;
		// return this;
		// }

		// public Jersey2ClientBuilder withDecoder(String decoderName, String
		// clientDataAccept) {
		// return
		// this.withDecoderWrapper(CodecWrappers.resolveDecoder(decoderName,
		// clientDataAccept));
		// }

		// public Jersey2ClientBuilder withDecoderWrapper(DecoderWrapper
		// decoderWrapper) {
		// this.decoderWrapper = decoderWrapper;
		// return this;
		// }

		public Jersey2Client build() {
			MyDefaultApacheHttpClient4Config config = new MyDefaultApacheHttpClient4Config();
			try {
				return new Jersey2ClientImpl(connectionTimeout, readTimeout, connectionIdleTimeout, config);
			} catch (Throwable e) {
		...
		class MyDefaultApacheHttpClient4Config extends ClientConfig {
			...
			MyDefaultApacheHttpClient4Config() {
				...
				// DiscoveryJerseyProvider discoveryJerseyProvider = new
				// DiscoveryJerseyProvider(encoderWrapper,
				// decoderWrapper);
				...
				// userAgent == null ? clientName : userAgent) + "/v"+
				// buildVersion()
				String fullUserAgentName = (userAgent == null ? clientName : userAgent) + "/v" ;
				property(CoreProtocolPNames.USER_AGENT, fullUserAgentName);

				// To pin a client to specific server in case redirect happens,
				// we handle redirects directly
			...
			private void addProxyConfiguration() {
				if (proxyUserName != null && proxyPassword != null) {
					...
					// Due to bug in apache client, user name/password must
					// always be set.
			...
			private PoolingHttpClientConnectionManager createSystemSslCM() {
				...
				Registry<ConnectionSocketFactory> registry = RegistryBuilder.<ConnectionSocketFactory>create()
						.register(PROTOCOL, socketFactory).build();
	...
	private class ConnectionCleanerTask implements Runnable {
		...
		public void run() {
			...
			try {
				HttpClientConnectionManager cm = (HttpClientConnectionManager) apacheHttpClient.getConfiguration()
